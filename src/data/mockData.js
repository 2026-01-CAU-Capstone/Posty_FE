import sample1Url from '../assets/sample1.jpg';
import sample2Url from '../assets/sample2.jpg';
...
export const sampleImages = [
  {
    ...
    label: '성수동 오후 3:20',
    subject: '라떼 + 디저트 + 창가 테이블',
    note: 'soft daylight / marble table',
    background: 'linear-gradient(145deg, #f7e1ce 0%, #e8b994 42%, #7f5b4b 100%)',
    glowA: 'rgba(255, 244, 214, 0.96)',
    glowB: 'rgba(255, 196, 146, 0.52)',
  },
  {
    id: 'editorial-rack',
    src: sample2Url,
    ...
    label: '한남 쇼룸 오후 1:10',
    subject: '룩북 rack shot + styling props',
    note: 'editorial framing / neutral beige',
    background: 'linear-gradient(145deg, #efe5db 0%, #ceb8a2 40%, #5c4d47 100%)',
    glowA: 'rgba(255, 247, 233, 0.92)',
    glowB: 'rgba(217, 195, 170, 0.48)',
  },
  {
    id: 'beauty-counter',
    fileName: 'beauty_counter_detail.heic',
    label: '청담 스튜디오 오전 11:40',
    subject: '브랜드 제품 + 유리 카운터 반사',
    note: 'clean highlight / glossy surface',
    background: 'linear-gradient(145deg, #f0ece8 0%, #d9c5ba 38%, #7e655d 100%)',
    glowA: 'rgba(255, 247, 242, 0.92)',
    glowB: 'rgba(228, 198, 178, 0.46)',
  },
];
